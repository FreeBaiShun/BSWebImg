...
/**
 ...
 Coders
 ------
 A coder must conform to the `BSWebImageCoder` protocol or even to `BSWebImageProgressiveCoder` if it supports progressive decoding
 ...
 */
@interface BSWebImageCodersManager : NSObject<BSWebImageCoder>
 ...
 */
@property (nonatomic, strong, readwrite, nullable) NSArray<BSWebImageCoder>* coders;
