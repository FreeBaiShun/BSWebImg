...
/**
 ...
 For a full GIF support, we recommend `FLAnimatedImage` or our less performant `BSWebImageGIFCoder`
 ...
 */
@interface BSWebImageImageIOCoder : NSObject <BSWebImageProgressiveCoder>
