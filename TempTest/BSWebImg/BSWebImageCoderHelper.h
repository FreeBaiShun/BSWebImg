...
@interface BSWebImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<BSWebImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<BSWebImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage;
