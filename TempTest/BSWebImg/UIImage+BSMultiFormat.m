...
@implementation UIImage (BSMultiFormat)
...
+ (nullable UIImage *)sd_imageWithData:(nullable NSData *)data {
    return [[BSWebImageCodersManager sharedInstance] decodedImageWithData:data];
}
...
- (nullable NSData *)sd_imageDataAsFormat:(SDImageFormat)imageFormat {
    ...
    if (self) {
        imageData = [[BSWebImageCodersManager sharedInstance] encodedDataWithImage:self format:imageFormat];
    }
    return imageData;
}
