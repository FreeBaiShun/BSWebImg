 ...
 */
FOUNDATION_EXPORT NSString * _Nonnull const BSWebImageCoderScaleDownLargeImagesKey;
 ...
 */
CG_EXTERN CGColorSpaceRef _Nonnull BSCGColorSpaceGetDeviceRGB(void);
 ...
 */
@protocol BSWebImageCoder <NSObject>
...
/**
 ...
 @param optionsDict A dictionary containing any decompressing options. Pass {BSWebImageCoderScaleDownLargeImagesKey: @(YES)} to scale down large images
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol BSWebImageProgressiveCoder <BSWebImageCoder>
